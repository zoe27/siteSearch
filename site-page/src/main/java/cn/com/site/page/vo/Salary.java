...
public class Salary implements Serializable {
    ...
    public Salary(String company, String title,
                  String level, Float yearOfExp, Float yearInCome,
                  Float bounsComp, Float baseComp, Float totalComp,
                  Float baseOfMonth, Integer stockComp, String degree,
                  String location, Integer hireType, String hours, String college) {
